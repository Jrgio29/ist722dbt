...
create or replace transient table analytics.dbt_jrgio29_northwind.obt_order_fulfillment
    
    as (with f_order_fulfillment as (
    select * from analytics.dbt_jrgio29_northwind.fact_order_fulfillment
),
d_customer as (
